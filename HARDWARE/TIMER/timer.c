...
void TIM4_CLOSE()
{
	//TIM3->ARR=9999;  	//设定计数器自动重装值 
	//TIM3->PSC=7199;  	//预分频器设置
	TIM_Cmd(TIM4, DISABLE);    //关闭定时器3
}
